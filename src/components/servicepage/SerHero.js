            ...
            <div className='w-full flex justify-center'>
                <div className='w-[90%] max-md:hidden flex justify-center relative'>
                    ...
                    <div className='absolute top-[4%] max-lg:top-[2%] left-0 flex flex-col gap-2 max-xl:gap-0'>
                        ...
                        <p className='text-[#062B43] w-[55%] text-[38px] max-xl:text-[30px] max-lg:text-[22px] font-bold leading-10 max-xl:leading-8 max-lg:leading-6'>Your Go-To Partner for Reacruitment, IT Training, and Web & App Development</p>
                    </div>
                    <div className='absolute left-[51%] flex bottom-[4%] max-xl:bottom-0'>
                        <h3 className='text-[20px] max-xl:text-[16px] max-lg:text-[14px] max-md:text-[12px] text-[#175574] leading-6 max-lg:leading-4'>Achieve your business goals with our comprehensive services. At Hiring Tech, we specialize in Recruitment, advanced IT Training, and cutting-edge Web & App Development. We are committed to delivering innovative solutions to help you reach new heights.</h3>
                    </div>
                </div>
