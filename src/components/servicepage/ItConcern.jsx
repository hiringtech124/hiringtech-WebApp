...
import img2 from './assets/z2.png'
import img3 from './assets/z3.png'
import img4 from './assets/z4.png'
          ...
          <div className='w-full h-full relative max-lg:h-full'>
            <div className={`flex ${service.style} max-lg:flex-wrap max-lg:justify-center max-lg:items-center max-w-6xl max-xl:w-[90%] mx-auto justify-center gap-40 max-xl:gap-10 items-center bg-white p-8 max-md:p-4 max-sm:p-4 max-sm:mx-auto rounded-[50px] max-sm:rounded-[20px] max-md:gap-10 max-sm:gap-2 `}>
              <div className='h-full bg-inc-100 flex-col relative justify-center items-center flex'>
                <Image src={service.image} alt={service.alt} className='m-auto' />
                {/* <div className="w-[631.03px] max-md:w-full text-[#175574] text-[22px] font-normal leading-[33.04px] max-sm:text-[40px] absolute top-4 right-4 text-end max-md:hidden">
                  {service.alt}
                </div> */}
              </div>
              <div className='max-md:w-full'>
                <div className='text-[#175574] text-[41px] max-xl:text-[34px] max-md:text-[28px] max-sm:text-[20px] font-bold leading-[33.04px] '>
                  {service.title}
                </div>
                <div className='max-md:ml-0 mt-[20px] max-sm:mt-2 flex-col justify-center items-start gap-[30px] inline-flex max-xl:ml-4'>
                  <div className='flex-col justify-start items-start gap-[42px] flex'>
                    <div className='flex-col justify-start items-start gap-[22px] flex'>
                      <div className="w-[513.61px] max-xl:w-[450px] max-md:w-full opacity80 text-[#175574] font-normal leading-normal text-[18px] max-xl:text-[16px] max-sm:text-[14px]">
                        {service.description}
                      </div>
                    </div>
                  </div>
