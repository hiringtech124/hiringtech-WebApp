    ...
    return (
        <>
            <div className='w-full flex justify-center'>
                <div className='w-[90%] h-full flex justify-between max-md:flex-col pt-20 pb-[50px]'>
                    <div className='h-full relative pt-[40px] max-sm:pt-[20px] py-[50px]'>
                        ...
                        <div className='flex items-center'>
                            <div className='flex flex-col gap-5 max-xl:gap-3 max-sm:gap-2 w-[600px] max-xl:w-[450px] max-lg:w-[350px] max-md:w-full text-[#062B43] '>
                                ...
                                <div className='flex gap-10 max-xl:gap-5 max-lg:gap-1 max-md:gap-40 max-sm:gap-10'>
                    ...
                    <div className='flex w-full h-full items-center justify-end max-md:justify-center relative'>
                        <Image src={img} className='w-[550px] h-[400px] max-xl:w-[450px] max-xl:h-[350px] max-lg:w-[350px] max-lg:h-[250px] max-md:w-full max-md:h-full' alt='sdgsdf' />
                        <div className='bg-[#175574] px-[10px] max-lg:px-[5px] py-[10px] max-lg:py-[8px] max-sm:py-1 flex items-center gap-1 rounded-xl max-sm:rounded-lg absolute bottom-[0%] max-md:right-0'>
                            <Image src={star} alt="fwfqe" />
                            <p className='text-[#fff] text-[20px] max-xl:text-[16px] max-lg:text-[12px] max-md:text-[22px] max-sm:text-[9px] tracking-tighter'>4.1  25k+ Reviews</p>
                        </div>
                    </div>
                </div>
            </div>
