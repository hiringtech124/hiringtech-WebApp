                    ...
                    <div className='w-[40%] max-md:w-[70%] max-sm:w-full flex flex-col gap-5 max-lg:gap-2'>
                        ...
                        <div className="flex justify-center items-center">
                            <div className="flex items-center bg-white rounded-full shadow-lg">
                                ...
                                />
                                <button className="bg-[#D79442] text-[20px] max-xl:text-[16px] max-lg:text-[14px] text-white py-2 px-6 rounded-r-full hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    Register
                                </button>
                            </div>
                        </div>
                        <div className='flex items-center'>
                            <input
                                id="consentCheckbox"
                                type="checkbox"
                                className=" h-10 w-10 text-[#D79442] rounded focus:ring-indigo-500"
                            />
