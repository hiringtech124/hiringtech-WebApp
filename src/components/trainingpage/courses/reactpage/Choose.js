...
import icon1 from "./assets/icon-box1.png"
import icon2 from "./assets/icon-box2.png"
import icon3 from "./assets/icon-box3.png"
import icon4 from "./assets/icon-box4.png"
import icon5 from "./assets/icon-box5.png"
// sdjfdj
