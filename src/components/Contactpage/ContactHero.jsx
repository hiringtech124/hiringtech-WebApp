...
const ContactHero = () => {
  ...
  return (
    <>
      <section className='contact-hero flex justify-center w-ful pt-20 max-md:py-5'>
        <div className='w-[90%]'>
          <h2 className='text-[41px] max-md:text-[24px] text-[#062B43] font-bold'>
            Got any queries? Feel free to connect with us!
          </h2>

          <div className='flex justify-center mt-10 max-md:mt-5 gap-20 max-sm:gap-10 items-start max-lg:flex-col-reverse max-lg:justify-center max-w-7xl mx-auto'>
            <div className='address-div2  w-[60%] max-md:w-full'>
              <div className='max-w-7xl mx-auto'>
                <div className='mapouter  w-full w[500px] h-[500px] max-md:h-[300px] max-md:w-full'>
                  <div className='gmap_canvas'>
                    <iframe
                      className='gmap_iframe w-[100%] h-[500px] max-md:h-[300px] max-md:w-full'
                      frameborder='0'
                      scrolling='no'
                      marginheight='0'
            ...
            >
              ...
              <div
                ...
                className='justify-center max-md:w-full px-9 py-4 max-sm:py-2 rounded-[54px] border-white border-solid border-[0.5px] max-md:px-5 ettal hoverborder-[#00557E] hovertext-[#00557E] hoverg-[#E3F5FE] cursor-pointer text-white w- text-center bg-[#D79442]'
              >
                Submit
              </div>
            </div>
      ...
      <div className='w-full flex justify-center'>
        <div className='w-[90%] py-20 max-md:py-5'>
          <div className='mapouter max-md:w-full max-md:h-full'>
            {/* <h1 className='address-head'>Office</h1> */}
            <section className=' '>
              <div className='contacts-info justify-start items-start'>
                <h2 className='text-[#062B43] text-[41px] max-md:text-[28px] font-semibold pb-10'>Contact details</h2>
